...
import { navItemForRoute } from '../config/nav'
...
// "Masjid" / "Kajian" / "Perpustakaan" / "Profil"). Title updates
// automatically from the current route via React Router's useLocation —
// this is the persistent app-shell header, rendered once by AppLayout.
export default function AppHeader() {
  const location = useLocation()
  const { headerTitle } = navItemForRoute(location.pathname)
